...
def load_env():
    ...
    return OPENAI_GPT5_NANO, LLAMA3_3, GEMINI_2_5_FLASH
...
def test_response_format_gemini_problem(load_env): #https://github.com/BerriAI/litellm/issues/7808
    load_dotenv(override=True)
    OPENAI_GPT5_NANO, LLAMA3_3, GEMINI_2_5_FLASH = load_env
    ...
    #response = litellm.completion(**OPENAI_GPT5_NANO, tools=[], stream=False, messages=messages, response_format=Annotation) #Works!
...
def test_grok_bug_regression(load_env):
    OPENAI_GPT5_NANO, LLAMA3_3,_ = load_env
    triple_func_call(OPENAI_GPT5_NANO)
