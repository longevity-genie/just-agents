...
def test_tool_factory_conflict_detection_mcp_vs_import():
    ...
    conflict_dict = {
        ...
        "package": "some.module",
        "mcp_endpoint": "http://test.example.com"
    }
...
def test_tool_factory_conflict_detection_multiple_mcp_endpoints():
    """Test that JustToolFactory properly detects and rejects multiple MCP endpoint parameters."""
    # This test is no longer relevant since we have only one mcp_endpoint parameter
    # Instead, test that a tool with only mcp_endpoint works correctly
    valid_dict = {
        "name": "valid_mcp_tool",
        "mcp_endpoint": "http://test.example.com"
    }
