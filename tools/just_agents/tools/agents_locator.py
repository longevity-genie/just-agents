...
def call_fallback_agent(agent_name: str, user_query: str, agent_codename: Optional[str] = None, call_the_first_instance: bool = True) -> str:
    """
    Call the fallback agent with the given name.
