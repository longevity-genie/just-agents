...
from just_agents.llm_options import LLAMA3_1
...
def purchase_example():
    ...
    customer: ChatAgent = ChatAgent(llm_options = LLAMA3_1, role = "customer at a shop",
                                   goal = "Your goal is to order what you want, while speaking concisely and clearly",
                                   task="Find the best headphones!")
    storekeeper: ChatAgent = ChatAgent(llm_options = LLAMA3_1,
